                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Login with Otp Two".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.loginWithOtpTwoScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Login with Otp Three".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.loginWithOtpThreeScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "OTP input - Empty".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.otpInputEmptyScreen),
                        ),
                        _buildScreenTitle(
                          context,
